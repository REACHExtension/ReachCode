...
run {RepOk} for 1 but exactly 1 BinaryTree
run {RepOk and #BinaryTree != 1} for 1 but exactly 1 Node

run {RepOk and #BinaryTree != 2} for 2 but exactly 2 Node

run {RepOk and #BinaryTree != 3} for 3 but exactly 3 Node
