...
run {RepOk and #BinaryTree = 0 and #Node = 0} for 0

run {RepOk and #BinaryTree = 1} for 1 
run {RepOk and #BinaryTree < 1 and #Node = 1} for 1 

run {RepOk and #BinaryTree = 2} for 2 
run {RepOk and #BinaryTree < 2 and #Node = 2} for 2 

run {RepOk and #BinaryTree = 3} for 3 
run {RepOk and #BinaryTree < 3 and #Node = 3} for 3 
