...
run {m1_minus_m2 and #FName = 0} for 0 but 5 int
run {m1_minus_m2 and #FName < 0 and #EnumVal = 0} for 0 but 5 int
run {m1_minus_m2 and #FName < 0 and #EnumVal < 0 and #Val = 0} for 0 but 5 int
run {m1_minus_m2 and #FName < 0 and #EnumVal < 0 and #Val < 0 and #Obj = 0} for 0 but 5 int

run {m1_minus_m2 and #FName = 1} for 1 but 5 int
run {m1_minus_m2 and #FName < 1 and #EnumVal = 1} for 1 but 5 int
run {m1_minus_m2 and #FName < 1 and #EnumVal < 1 and #Val = 1} for 1 but 5 int
run {m1_minus_m2 and #FName < 1 and #EnumVal < 1 and #Val < 1 and #Obj = 1} for 1 but 5 int

run {m1_minus_m2 and #FName = 2} for 2 but 5 int
run {m1_minus_m2 and #FName < 2 and #EnumVal = 2} for 2 but 5 int
run {m1_minus_m2 and #FName < 2 and #EnumVal < 2 and #Val = 2} for 2 but 5 int
run {m1_minus_m2 and #FName < 2 and #EnumVal < 2 and #Val < 2 and #Obj = 2} for 2 but 5 int

run {m1_minus_m2 and #FName = 3} for 3 but 5 int
run {m1_minus_m2 and #FName < 3 and #EnumVal = 3} for 3 but 5 int
run {m1_minus_m2 and #FName < 3 and #EnumVal < 3 and #Val = 3} for 3 but 5 int
run {m1_minus_m2 and #FName < 3 and #EnumVal < 3 and #Val < 3 and #Obj = 3} for 3 but 5 int

run {m1_minus_m2 and #FName = 5} for 5 but 5 int
run {m1_minus_m2 and #FName < 5 and #EnumVal = 5} for 5 but 5 int
run {m1_minus_m2 and #FName < 5 and #EnumVal < 5 and #Val = 5} for 5 but 5 int
run {m1_minus_m2 and #FName < 5 and #EnumVal < 5 and #Val < 5 and #Obj = 5} for 5 but 5 int

run {m1_minus_m2 and #FName = 6} for 6 but 5 int
run {m1_minus_m2 and #FName < 6 and #EnumVal = 6} for 6 but 5 int
run {m1_minus_m2 and #FName < 6 and #EnumVal < 6 and #Val = 6} for 6 but 5 int
run {m1_minus_m2 and #FName < 6 and #EnumVal < 6 and #Val < 6 and #Obj = 6} for 6 but 5 int
